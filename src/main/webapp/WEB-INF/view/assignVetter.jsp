...
<div class="container">
	...
	<input type="button" value="Add New Vetter" class="btn btn-default" id="addNewVetter" />
	<input type="button" value="Delete Vetter" class="btn btn-default" id="deleteVetter" />
	...
	<br />
	<input id="saveRequirement" type="button" class="btn btn-success" value="Save" />
	<br>
